...
export default function FeelGoodDetail({ onBack, recommendations, recLoading }: Props) {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.heroSection}>
        <View style={styles.heroCard}>
          <Text style={styles.heroTitle}>Foods for 😊 Feel Good</Text>
          <Text style={styles.heroSubtitle}>Boost your mood with these feel-good foods</Text>
        </View>
      </View>

      {/* Mascot Tip */}
      <View style={styles.tipSection}>
        <Text style={styles.tipText}>"Eat well, feel happy!"</Text>
      </View>
